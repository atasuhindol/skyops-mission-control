    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'lastMaintenanceDate', type: 'timestamp', isNullable: true },
          { name: 'nextMaintenanceDueDate', type: 'timestamp', isNullable: true },
          { name: 'registrationTimestamp', type: 'timestamp', isNullable: false },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'plannedStart', type: 'timestamp', isNullable: false },
          { name: 'plannedEnd', type: 'timestamp', isNullable: false },
          { name: 'actualStart', type: 'timestamp', isNullable: true },
          { name: 'actualEnd', type: 'timestamp', isNullable: true },
    ...
    await queryRunner.createTable(
      new Table({
        ...
        columns: [
          ...
          { name: 'datePerformed', type: 'timestamp', isNullable: false },
